...
function ServiceCard({ icon, title, description }: ServiceCardProps) {
  return (
    <div className="rounded-2xl p-6 flex flex-col h-full hover:text-white border-zinc-300 border-[1px] transform hover:bg-gradient-to-r hover:from-[#062C7E] hover:to-[#2150FD]">
      <div className="bg-zinc-200 w-16 h-16 rounded-lg flex items-center justify-center mb-6 group-hover:bg-blue-700">
        {icon}
      </div>
